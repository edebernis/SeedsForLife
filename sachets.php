...
<html>
  ...
  <body>
		...
		<div id="main" class="row-fluid">
			<div id="left-menu" class="span2">
				<ul id="left_menu_list" class="nav nav-pills nav-stacked">
	  				...
	  				<li class="active"><a href="sachets.php">Des sachets en cadeau</a></li>
			...
			<div id="center" class="span10">
				<?php
					...
					?>
				<div class="page-header"><h1>T&eacute;moignage dans un sachet de toile de jute</h1></div>
					<img class="text_img_right" src="img/sachets3.png" alt>
					<p class="text">Vous recevrez en retour de vos dons des sachets pour en <span>t&eacute;moigner</span>.<br />
					Ces sachets contiennent quelques <span>graines de Croton</span> pour que vous puissiez voir et toucher ce que vous permettez de replanter. <span>Une petite notice</span> se glisse dans le sachet.<br />
					Entreprises ? Demandez nous de personnaliser ces notices !<br />
					Les sachets sont fabriqu&eacute;s sur mesure en <span>toile de jute naturelle</span>, signe de notre <span>engagement &eacute;cologique</span>. Le jute est en effet un mat&eacute;riau respectueux de l'environnement, <span>100% recyclable, il ne pollue pas</span>. Le jute est extrait d'une fibre v&eacute;g&eacute;tale (le Corchorus Capsularis), il n'est pas besoin d'abattre d'arbre pour le produire. <span>Plus de 10 coloris disponibles, choisissez !</span><br />
					Ces graines, vous pourrez les planter chez vous, selon les instructions donn&eacute;es sur la notice qui accompagne chaque sachet. Vous pourrez aussi le garder entre-ouvert sur votre bureau, comme une <span>invitation au voyage</span>, &agrave; l'ouverture au monde. <span>&laquo; Seeds for Life &raquo;</span> propose bien plus qu'un produit: <span>agir pour l'environnement, le dire, voir et toucher l'objet m&ecirc;me de son action</span>.<br />
					C'est surtout le moyen de communiquer facilement sur votre engagement pour la reforestation&nbsp;: en soutenant <span>&laquo; Seeds for Life &raquo;</span>, j'annule ma consommation de CO2, je compense ma consommation de papier au bureau...</p>
				</div>
		</div>
	...
	<div id="commandModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="commandModalLabel" aria-hidden="true">
	  ...
	  <form class="form-horizontal" method="POST" action="commande.php?page=sachets">
	...
	<div id="contactModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="contactModalLabel" aria-hidden="true">
	  ...
	  <form class="form-horizontal" method="POST" action="contact.php?page=sachets">
	  <div class="modal-body">
