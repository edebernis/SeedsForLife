...
<html>
  ...
  <body>
		...
		<div id="main" class="row-fluid">
			<div id="left-menu" class="span2">
				<ul id="left_menu_list" class="nav nav-pills nav-stacked">
	  				...
	  				<li class="active"><a href="enfants.php">Le coin des enfants</a></li>
			...
			<div id="center" class="span10">
				...
				<?php
					...
					?>
				<div class="page-header"><h1>Le coin des enfants</h1></div>
				<p class="text"><span>Des petits &eacute;l&egrave;ves de nos &eacute;coles partenaires</span>, entre 10 et 14 ans. Ils t&eacute;moignent de leur reconnaissance et vous dessinent ce qu'ils ont sur le coeur !</p>
				<img class="text_img" src="img/kids1.jpg" alt>
				<img class="text_img" src="img/kids2.jpg" alt>
				<img class="text_img" src="img/kids3.jpg" alt>
				<img class="text_img" src="img/kids4.jpg" alt>
				<img class="text_img" src="img/kids5.jpg" alt>
				<img class="text_img" src="img/kids6.jpg" alt>
			</div>
		</div>
	</div>
	<footer class="footer">
	...
	<div id="commandModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="commandModalLabel" aria-hidden="true">
	  ...
	  <form class="form-horizontal" method="POST" action="commande.php?page=enfants">
	...
	<div id="contactModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="contactModalLabel" aria-hidden="true">
	  ...
	  <form class="form-horizontal" method="POST" action="contact.php?page=enfants">
	  <div class="modal-body">
